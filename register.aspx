...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <table 
        style="width: 46%; border-style: solid; border-width: 1px; margin-left: 0px; margin-right: 0px; height: 400px;"
        align="center">
            <tr>
                <td class="style1" colspan="2" align="center">
                    &nbsp; &nbsp;<span class="style6">ENTER YOUR DETAILS:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style5" colspan="2">
                    ...
                    &nbsp;<asp:Button ID="Button1" runat="server" Text="Register" 
                        onclick="Button1_Click" BackColor="#FF3300" />
